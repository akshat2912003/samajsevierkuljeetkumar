...
import fanImg1 from "./assets/fan1.jpeg";
import fanImg2 from "./assets/fan2.jpeg";
import fanImg3 from "./assets/fan3.jpeg";
import fanImg4 from "./assets/fan4.jpeg";
import fanImg5 from "./assets/fan5.jpeg";
...
const FAN_BENEFICIARIES_HI = [
  ...
  {
    name: "शिव दुलारी देवी",
    relation: "पति — भूखन बिन",
    address: "ग्राम महादेव चक, हरिपुर, पुराना हरिपुर, जिला भोजपुर (बिहार)",
    dob: "01/01/1955",
    desc: "उम्र के इस पड़ाव में वे भीषण गर्मी के बीच बिना पंखे के जीवन बिताने को विवश थीं। उन्हें इस अभियान से बड़ी राहत मिली।",
    img: fanImg4,
  },
  {
    name: "दुरजना देवी",
...
const FAN_BENEFICIARIES_EN = [
  ...
  {
    name: "Aruna Devi",
    relation: "Husband — Late Dhaneshwar Pandit",
    address: "Pavna, Pavna Panchayat, Bhojpur District",
    desc: "Living in loneliness and deprivation after the demise of her husband. She also received the benefit of this campaign.",
    img: fanImg2,
  },
  {
  ...
  {
    name: "Shiv Dulari Devi",
    relation: "Husband — Bhukhan Bin",
    address: "Village Mahadev Chak, Haripur, Old Haripur, Bhojpur District (Bihar)",
    dob: "01/01/1955",
    desc: "At this stage of her life, she was forced to live without a fan in the scorching heat. This campaign brought her great relief.",
    img: fanImg4,
  },
  {
    name: "Durjana Devi",
...
export default function SocialWorkerWebsite() {
  ...
  return (
    <div>
      ...
      {/* FAN DISTRIBUTION CAMPAIGN */}
      <section
        id="fan-campaign"
        className="section-padding"
        style={{
          background: "linear-gradient(135deg, #FFF9F3 0%, #F5FAF5 100%)",
          position: "relative",
          overflow: "hidden",
        }}
      >
        ...
        <div
          style={{
            position: "absolute",
            inset: 0,
            backgroundImage: `radial-gradient(${COLORS.saffron}15 1px, transparent 1px)`,
            backgroundSize: "40px 40px",
            zIndex: 0,
          }}
        />
        ...
        >
          ...
          <FadeInSection>
            ...
            >
              ...
              >
                ...
                >
                  {lang === "hi" ? "सेवा संकल्प" : "Service Pledge"}
                </span>
                <span
                  style={{
                    display: "inline-block",
              ...
              >
                {lang === "hi" ? "पंखा वितरण अभियान" : "Fan Distribution Campaign"}
              </h2>
              <div
                style={{
                  width: 100,
              ...
              >
                {lang === "hi"
                  ? "“जिनका कोई सहारा नहीं, उनका सहारा — श्री कुलजीत कुमार”"
                  : "“Hope for the Hopeless — Shri Kuljeet Kumar”"}
              </p>
            </div>
          </FadeInSection>
          ...
          <FadeInSection>
            ...
            >
              ...
              >
                {lang === "hi"
                  ? "जब भीषण गर्मी अपने चरम पर होती है, तब शहरों में लोग वातानुकूलित कमरों और कूलर की ठंडी हवा में राहत तलाश लेते हैं। लेकिन गाँवों की उन जर्जर झोपड़ियों में, जहाँ तपती धूप सीधे घर के भीतर उतर आती है, वहाँ रहने वाले असहाय बुज़ुर्गों की पीड़ा कौन समझता है? जिनके पास न पर्याप्त साधन हैं और न ही आर्थिक क्षमता, वे दिनभर गमछे या पुराने आँचल से स्वयं को हवा करते हुए कठिन परिस्थितियों में जीवन बिताने को विवश रहते हैं।"
                  : "When the scorching summer heat reaches its peak, people in cities find comfort in air-conditioned rooms and the cool breeze of coolers. But who understands the suffering of the helpless elderly living in the dilapidated huts of villages, where the blazing sun pierces directly inside? Lacking both adequate resources and financial capability, they are forced to spend their days fanning themselves with towels or old clothes, surviving under extremely harsh conditions."}
              </p>
              <p
                style={{
                  fontSize: "1.1rem",
              ...
              >
                {lang === "hi"
                  ? "इसी मानवीय पीड़ा को महसूस करते हुए श्री कुलजीत कुमार ने एक सेवा-संकल्प लिया। मई माह से प्रारंभ हुआ यह पंखा वितरण अभियान किसी सरकारी योजना या संस्था द्वारा संचालित कार्यक्रम नहीं है, बल्कि यह उनका व्यक्तिगत सेवा-प्रयास है। वे स्वयं भोजपुर जिले के गाँव-गाँव जाकर वास्तविक ज़रूरतमंद लोगों की पहचान करते हैं और बिना किसी प्रचार-प्रसार या दिखावे के उन्हें पंखे उपलब्ध कराते हैं। न कोई कैमरा, न भीड़, न कोई मंच—सिर्फ सेवा का भाव और किसी ज़रूरतमंद के चेहरे पर राहत की मुस्कान।"
                  : "Moved by this human suffering, Shri Kuljeet Kumar took a vow of service. Initiated in the month of May, this Fan Distribution Campaign is not a government scheme or a program run by any organization; rather, it is his personal service endeavor. He personally visits village after village in Bhojpur district to identify the genuinely needy and provides them with fans without any publicity, show, or stage. No cameras, no crowds, no stages—just the spirit of service and a smile of relief on a needy person's face."}
              </p>
            </div>
          </FadeInSection>
          ...
          <FadeInSection>
            ...
            >
              ...
              >
                {lang === "hi" ? "अब तक लाभान्वित प्रमुख लाभार्थी" : "Key Beneficiaries Assisted So Far"}
              </h3>
              <div
                style={{
                  width: "60px",
          ...
          {/* Grid of Beneficiaries (Photos with Location overlays only) */}
          <div
            style={{
              display: "grid",
          ...
          >
            {(lang === "hi" ? FAN_BENEFICIARIES_HI : FAN_BENEFICIARIES_EN).map((beneficiary, i) => (
              <FadeInSection key={i} delay={i * 100}>
                <div
                  style={{
                    background: "#fff",
                  ...
                  onMouseEnter={(e) => {
                    ...
                    const img = e.currentTarget.querySelector(".fan-card-img");
                ...
                >
                  {/* Beneficiary Image Container */}
                  <div
                    onClick={() => setSelectedImage(beneficiary.img)}
                    style={{
                      height: "280px",
                      overflow: "hidden",
                      position: "relative",
          ...
          {/* Beneficiary Name Chips — compact horizontal grid */}
          <FadeInSection>
            <div
              style={{
                maxWidth: "1000px",
                ...
                {(lang === "hi" ? FAN_BENEFICIARIES_HI : FAN_BENEFICIARIES_EN).map((beneficiary, i) => (
                  <div
                    ...
                    style={{
                      ...
                      border: `1.5px solid ${i % 2 === 0 ? "rgba(232,97,44,0.30)" : "rgba(56,142,60,0.28)"}`,
                      borderRadius: "50px",
          ...
          {/* Campaign Conclusion Banner — warm soft gradient */}
          <FadeInSection>
            <div
              style={{
                background: `linear-gradient(135deg, #f5f0e8 0%, #eef4ec 50%, #e8f2e8 100%)`,
                borderRadius: "28px",
                padding: "2.5rem 2.5rem",
                color: "#2d4a2d",
                position: "relative",
                overflow: "hidden",
                boxShadow: "0 10px 35px rgba(80, 130, 80, 0.12), 0 2px 8px rgba(80,130,80,0.06)",
                textAlign: "center",
                border: "1px solid rgba(80, 150, 80, 0.2)",
              }}
            >
              {/* Decorative rings */}
              <div
                style={{
                  ...
                  height: "200px",
                  borderRadius: "50%",
                  border: "38px solid rgba(80,160,80,0.07)",
                  pointerEvents: "none",
                }}
              />
              <div
                style={{
                  ...
                  height: "170px",
                  borderRadius: "50%",
                  border: "32px solid rgba(232,97,44,0.07)",
                  pointerEvents: "none",
                }}
              />
              ...
              <div style={{ position: "relative", zIndex: 2, maxWidth: "760px", margin: "0 auto" }}>
                ...
                >
                  {lang === "hi"
                    ? "श्री कुलजीत कुमार के लिए ये वही चेहरे हैं जिनकी सेवा ही सच्ची समाज सेवा है — बिना किसी प्रशंसा की अपेक्षा, केवल मानवता के प्रति समर्पण।"
                    : "For Shri Kuljeet Kumar, these are the faces whose service is true social work — without expectation of praise, only dedication to humanity."}
                </p>
                <div
                  style={{
                    height: "1px",
                    background: "linear-gradient(90deg, transparent, rgba(80,150,80,0.35) 50%, transparent)",
                    margin: "1.25rem 0",
                  }}
                />
                <h4
                ...
                >
                  {lang === "hi"
                    ? "“जब तक भोजपुर में कोई ज़रूरतमंद बिना पंखे के जीवन बिताने को मजबूर है, यह सेवा अभियान जारी रहेगा।”"
                    : "“As long as any needy person in Bhojpur is forced to live without a fan, this service campaign will continue.”"}
                </h4>
              </div>
            </div>
          </FadeInSection>
